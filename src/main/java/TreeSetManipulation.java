...
public class TreeSetManipulation {
    public static void main(String[] args) {
        ...
        boolean element = treeSet.contains('B');
        System.out.println("Does the set contain 'B'? " + element);      
