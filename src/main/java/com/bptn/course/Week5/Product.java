...
public class Product {
  ...
  //Create getter for price to be able to filter by price
...
/* This was very interesting to work on and i encountered an issue where the code did not run as i did not create a getter method to access the private variable price which was required.
I 'll ensure to rememeber to create getters and setters for private fields when required */